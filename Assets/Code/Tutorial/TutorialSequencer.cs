...
public class TutorialSequencer : MonoBehaviour
{
    ...
    void GameEvent(TutorialEvent @event)
    {
        ...
        if (@event == TutorialEvent.MachineInterfaceClosed) { RenderConveyorIndicator = true; RenderCrusherIndicator = false; }
    ...
    void RenderIndicators()
    {
        ...
        if (RenderHopperIndicator)
        {
            ...
            TutorialProxy.SetPopupPosition(hopper_transform.position.ToVector3(), TutorialTag.HopperIndicatorPosition);
        }
        if (RenderCrusherIndicator)
        {
            ...
            TutorialProxy.SetPopupPosition(crusher_transform.position.ToVector3(), TutorialTag.CrusherIndicatorPosition);
        }
        if (RenderConveyorIndicator)
        {
            ...
            TutorialProxy.SetPopupPosition(conveyor_transform.position.ToVector3(), TutorialTag.ConveyorIndicatorPosition);
        }
    }
}
